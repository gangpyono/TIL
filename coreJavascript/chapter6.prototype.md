...
- 따라서 객체에서만 사용할 메서드는 다른 데이터 타입처럼 프로토타입 객체 안에 정의 할 수 없다. 왜냐하면 다른 데이터 타입도 해당 메서드를 사용 할 수 있게되기 떄문이고, 이를 해결하기위해선 어쩔 수없이 Object.prototype이 아닌 Object에 static 메서드로 부여할 수 밖에 없다.
